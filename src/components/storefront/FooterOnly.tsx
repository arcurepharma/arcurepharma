...
// Footer without the About Us section — used on product pages, etc.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-400 hover:text-[#e07aa0] text-sm transition-colors flex items-center gap-2 group">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-gray-400 text-sm">
                ...
                <a href="tel:+923341169999" className="hover:text-[#e07aa0] transition-colors">+92 334 116 9999</a>
              </li>
              <li className="flex items-center gap-3 text-gray-400 text-sm">
                <Mail className="w-4 h-4 text-[#e07aa0] shrink-0" />
                <a href="mailto:info@arcurepharma.com" className="hover:text-[#e07aa0] transition-colors">info@arcurepharma.com</a>
              </li>
              <li className="flex items-center gap-3 text-gray-400 text-sm">
          ...
          <div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-3">
              ...
              />
              <button type="submit" className="w-full px-4 py-3 bg-[#a83866] hover:bg-[#8a2a52] text-white text-sm font-semibold rounded-xl transition-all active:scale-95">
                Subscribe
              </button>
            </form>
          </div>
      ...
      <div className="border-t border-[#6b1f3e]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[#eca0bb]/60 text-xs">
            Created by <span className="text-[#e07aa0] font-semibold">Muhammad Ayan</span>
          </p>
        </div>
      </div>
    </footer>
