...
const WhatsAppButton = () => {
  // Find the WhatsApp link from the socialLinks array
  const whatsappData = socialLinks.find((link) => link.name === "WhatsApp");
  const whatsappLink = whatsappData ? whatsappData.url : "https://wa.me/";
