...
const sendOrderEmail = async (data, res) => {
  ...
  // Specific support info as requested
  const phoneVal = "03341169999";
  const whatsappUrl = `https://wa.me/${phoneVal.replace(/\s+/g, '')}`;
