    ...
    return (
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto px-4 pt-40 pb-20 text-center">
          ...
          <Link href="/" className="inline-flex items-center gap-2 mt-4 px-6 py-3 bg-[#a83866] text-white rounded-xl hover:bg-[#8a2a52] transition-colors">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-28 pb-20">
          ...
          <div id="invoice" className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-sm">
            ...
            <div className="flex items-start justify-between mb-6 pb-6 border-b border-gray-100">
              <div>
                ...
                <p className="text-[#a83866] text-xs font-semibold uppercase tracking-wider">Order Invoice</p>
              </div>
            ...
            <div className="space-y-1.5 mb-5">
              ...
              <div className="flex justify-between pt-3 border-t border-gray-100">
                ...
                <span className="font-bold text-[#a83866] text-xl">{formatPrice(order.totalAmount)}</span>
              </div>
            </div>

            <div className="text-center text-xs text-gray-400 pt-4 border-t border-gray-100">
              <p>Thank you for choosing <span className="text-[#a83866] font-semibold">Arcure Pharma</span>!</p>
          ...
          <div className="flex items-center justify-center gap-4 mt-8 no-print">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-[#fdf4f7] text-[#a83866] border border-[#fae3ec] font-semibold rounded-xl hover:bg-[#fae3ec] transition-colors text-sm"
            >
              <Printer className="w-4 h-4" /> Print Invoice
            </button>
            <Link
              href="/"
              className="flex items-center gap-2 px-6 py-3 bg-[#a83866] text-white font-semibold rounded-xl hover:bg-[#8a2a52] transition-colors text-sm"
            >
