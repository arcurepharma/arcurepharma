      ...
      <footer style={{ background: "linear-gradient(135deg, rgba(252,184,253,0.22) 0%, rgba(232,85,216,0.14) 100%)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderTop: "1px solid rgba(252,184,253,0.4)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            {/* Newsletter */}
            <div>
              <h4 className="font-bold text-gray-800 mb-5 text-sm uppercase tracking-wider">Stay Updated</h4>
              <p className="text-gray-500 text-sm mb-4">Subscribe for health tips, new products, and exclusive offers.</p>
